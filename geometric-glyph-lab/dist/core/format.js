...
export const CELL_ORIENTATION = "8-columns-by-16-rows";
/**
 ...
 */
export const BITMAP_SERIALIZATION = "v1:rows-top-to-bottom;one-byte-per-row;x0-is-bit0;lowercase-hex";
export const ASCII_FILLED_PIXEL = "#";
export const ASCII_EMPTY_PIXEL = "-";
export const UNICODE_FILENAME_HEX_WIDTH = 6;
export function assertCanonicalCell() {
    if (CELL_WIDTH !== 8 || CELL_HEIGHT !== 16) {
        throw new Error(`GraphSCII v1 requires an 8-column × 16-row cell; got ${CELL_WIDTH}×${CELL_HEIGHT}.`);
    }
}
...
export function glyphArtifactStem(codepoint) {

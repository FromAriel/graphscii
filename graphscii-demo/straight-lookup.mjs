...
//
// IMPORTANT: this module does not "solve" drawing cells.
// It only reconstructs the frozen v1 mapping from exact port-pair semantics to
// their already-assigned straight codepoints. The drawing engine asks for one
// exact semantic key and receives one exact codepoint.
